...
public class Unmarshall {
	...
	public Unmarshall defineComponents(Unmarshall unpacker) {
		if (unpacker != null) {
	...
	// Identify type of each property and build a new hashmap with fields and actual
	// values
